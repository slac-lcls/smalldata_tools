...
if ana is not None:
    ...
    ana.addCut('ipm2/sum',0.,10.,'onSel')
    ...
    #save photon images
    detDict = {'source':'jungfrau1M','photon_0p85':2.0, 'image':1}
    #ana.addCube('cubeDelay','delay',np.linspace(-267.5,-256,120),'onSel')
    ana.addCube('cubeDelay','delay',np.linspace(-267.5,-256,4),'onSel')
    ana.addToCube('cubeDelay',['ipm2/sum','ipm3/sum','diodeU/channels', detDict])

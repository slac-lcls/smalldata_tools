...
if have_epix:
    ...
    if (int(run)==444):
        #epix.addPhotons(ADU_per_photon=165, thresADU=0.9, nphotRet=nPhot, retImg=1)
        epix.addPhotons(ADU_per_photon=165, thresADU=0.9, retImg=2, nphotMax=200)
    else:
        epix.addPhotons(ADU_per_photon=144, thresADU=0.9, nphotRet=nPhot, retImg=1)
        #epix.addPhotons(ADU_per_photon=144, thresADU=0.9, retImg=2)

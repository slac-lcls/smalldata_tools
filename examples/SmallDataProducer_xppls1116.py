...
def getROI(run):
    ...
    if run <=3:
        ...
        return [[12,13], [28,70], [135,170]] # first rocking curve
    elif run <= 15:
	return [[12,13], [28,70], [135,170]]
    elif run <=44:
        return [ [[20,21], [1,43], [292,347]],
                 [[12,13], [16,56], [101,140]] ]
    elif run <=200:
        return [ [[26,27], [79,114], [34,82]],
                 [[26,27], [82,118], [38,83]],
                 [[25,26], [26,62], [227,263]],
                 [[14,15], [112,167], [76,172]],
                 [[25,26], [80,106], [233,261]] ]
    else:
        return []
...
ROIs = getROI(int(run))
cspadName = 'cspad'
haveCspad = checkDet(ds.env(), cspadName)
if haveCspad:
    cspad = DetObject(cspadName ,ds.env(), int(run), name=cspadName)

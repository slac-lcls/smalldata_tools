...
ROI_opal2 = getROI_opal2(int(run))
if checkDet(ds.env(), 'opal_2'):
    opal2 = DetObject('opal_2' ,ds.env(), int(run))
    for iROI,ROI in enumerate(ROI_opal2):
        opal2.addROI('ROI_%d'%iROI, ROI, writeArea=True)
    dets.append(opal2)

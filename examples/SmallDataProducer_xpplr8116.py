...
if have_epix:
    ...
    epix.addDroplet(threshold=10., thresholdLow=3., thresADU=0.,name='droplet')
    epix['droplet'].addDropletSave(maxDroplets=nDrop)
    epix['droplet'].addDropletSave(maxDroplets=nDrop, name='ROI_filter', ROI=[[247,286], [340,371]])
    epix['droplet'].add_aduHist(ROI=[[247,286], [340,371]], ADUhist=[400],name='ROI_filter')
    epix['droplet'].add_aduHist(ROI=[[367,410], [405,436]], ADUhist=[400],name='ROI_nofilter')
    epix.addROI('ROI_filter',[[247,286], [340,371]])
    epix.addROI('ROI_nofilter',[[367,410], [405,436]])
    dets.append(epix)

...
if diode2Dim.name in ana.Keys():
    ...
    diode20vTime = hv.Scatter((eventTimeR, diode2[:,0]), kdims=[eventTimeDim, diode2Dim]).options(color='g', alpha=0.3)
    diode20vTimeMed= hv.Curve((eventTimeRMed, diode2Med[:,0]), kdims=[eventTimeDim, diode2Dim]).options(color='k')
    diode21vTime = hv.Scatter((eventTimeR, diode2[:,1]), kdims=[eventTimeDim, diode2Dim]).options(color='g', alpha=0.3)
    diode21vTimeMed= hv.Curve((eventTimeRMed, diode2Med[:,1]), kdims=[eventTimeDim, diode2Dim]).options(color='k')
    diode22vTime = hv.Scatter((eventTimeR, diode2[:,2]), kdims=[eventTimeDim, diode2Dim]).options(color='g', alpha=0.3)
    diode22vTimeMed= hv.Curve((eventTimeRMed, diode2Med[:,2]), kdims=[eventTimeDim, diode2Dim]).options(color='k')
    diode23vTime = hv.Scatter((eventTimeR, diode2[:,3]), kdims=[eventTimeDim, diode2Dim]).options(color='g', alpha=0.3)
    diode23vTimeMed= hv.Curve((eventTimeRMed, diode2Med[:,3]), kdims=[eventTimeDim, diode2Dim]).options(color='k')
